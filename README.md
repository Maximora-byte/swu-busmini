...
项目已完成 **Phase 7：单线路直达推荐**。当前版本可以获取并显示用户位置，在 1～9 路之间切换并查看图示方向和纵向站序；校园地点知识层支持按名称或别名搜索地点，并通过已登记的关联站点推荐可到达线路、匹配方向及灵活停靠提示。独立验证器、CLI 与 GitHub Actions 会持续检查线路、来源和 POI 数据质量。
...
10. 结合 2026 年站牌、通知和实际乘车复核线路及 POI 关系；
11. 接入上车前、下车后的步行路线；
12. 增加路线排序、时刻表和多方案；
